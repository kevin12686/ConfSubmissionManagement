    ...
    return [
        ...
        },
        {
            ...
            "metrics": [
                ...
                },
                {
                    ...
                    "help": "Final submissions retained for tracking but excluded from the publication package.",
        ...
        },
        {
            ...
            "metrics": [
                ...
                {
                    "label": "Corrected PDFs Need Process",
                    "value": counts["corrected_pdf_needs_processing"],
                    "help": "Corrected PDFs were uploaded after the current page count/hash/active-final copy.",
                    "level": _issue_level(counts["corrected_pdf_needs_processing"], "danger"),
                    "status_label": _issue_status(counts["corrected_pdf_needs_processing"], "Process"),
